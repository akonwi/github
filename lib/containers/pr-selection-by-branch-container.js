...
export class PrSelectionByBranch extends React.Component {
  ...
  renderCreatePr() {
    return (
      <div className="github-PrUrlInputBox-Container">
        ...
        <PrUrlInputBox onSubmit={this.props.onSelectPr}>
          <p>
            <a>Search again</a> to discover an existing pull request, or manually link a GitHub pull request to the
            current branch by entering its URL:
          </p>
        </PrUrlInputBox>
      </div>
    );
  ...
  renderCreatePrControl() {
    ...
    const disableCreatePr = pushNeeded;
